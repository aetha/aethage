...
#
# Origin: phackerlay overlay
# https://gitlab.phys-el.ru/gentoo/phackerlay/-/tree/master/sci-ml/torchaudio
...
DEPEND="
	...
	>=sci-ml/pytorch-2.11:=[cuda(-)?,rocm(-)?,openmp(-)?,${PYTHON_SINGLE_USEDEP}]
"
RDEPEND="
	${DEPEND}
"
